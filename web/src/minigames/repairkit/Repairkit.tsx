...
const RepairKit = () => {
  ...
  const handleGameOver = (result?: boolean) => {
    if (gameStatus !== 1) return; // Ignore if game not running
    ...
    >
      <div
        className={classNames(
          ...
          gameStatus != 2
            ? `
                    from-[rgb(0_183_140)] to-[rgb(0,81,61)] bg-[#38a2e5]
                `
            : `
                    from-[rgb(255_85_76)] to-[rgb(132_32_32/0.894)] bg-[rgb(132_32_32/0.894)]
                `
        )}
      >
        E
        ...
        >
          <div
            className={classNames(
              ...
              gameStatus !== 2
                ? `
                                from-[#38a2e5] to-[#38a2e5]
                                shadow-[0_0_5px_0px_#38a2e5] bg-[#38a2e5]
                            `
                : `
                                from-[rgb(255_85_76)] to-[rgb(132_32_32/0.894)]
                                shadow-[0_0_5px_0px_rgb(255_0_0)] bg-[rgb(132_32_32/0.894)]
                            `,
